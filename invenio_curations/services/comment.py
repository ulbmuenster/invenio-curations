...
class CommentProcessor:
    ...
    def _create_new_comment(
        ...
        identity = system_identity if use_system_identity else self._identity
    ...
    def _handle_critiqued_resubmit_status(
        ...
        :param use_system_identity: If True, use system identity for auto-generated comments.
        """
        last_event = list(
        ...
        # if last event is a comment generated by this processor
            ...
            self._compute_diff_and_update_event(
                last_event, new_data, msg, errors, use_system_identity=use_system_identity
            )
    ...
    def process_comment(
        ...
        current_draft: dict,
        errors: list[dict] | None,
        use_system_identity: bool | None = None,
    ) -> None:
